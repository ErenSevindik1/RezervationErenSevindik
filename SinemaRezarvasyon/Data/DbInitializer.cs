...
namespace RezervationErenSevindik
{
    public static class DbInitializer
    {
        private static string connectionString = "Data Source=..\\..\\files\\RezervationErenSevindikDb.db;Version=3;";

        public static void InitializeDatabase()
        {
            if (!File.Exists("..\\..\\files\\RezervationErenSevindikDb.db"))
            {
                SQLiteConnection.CreateFile("..\\..\\files\\RezervationErenSevindikDb.db");
                using (var connection = new SQLiteConnection(connectionString))
                {
                    ...
                    INSERT INTO Film (FilmAdi) VALUES ('Goodfellas');
                    INSERT INTO Film (FilmAdi) VALUES ('The Intern');
                    INSERT INTO Film (FilmAdi) VALUES ('Scarface');
                    INSERT INTO Film(FilmAdi) VALUES(' The Dark Knight');";
